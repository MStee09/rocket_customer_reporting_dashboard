  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={handleClick}
        role={isClickableForNavigation && !isEditMode ? 'button' : undefined}
        tabIndex={isClickableForNavigation && !isEditMode ? 0 : undefined}
        onKeyDown={isClickableForNavigation && !isEditMode ? (e) => {
