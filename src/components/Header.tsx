...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-charcoal-200 sticky top-0 z-30">
        <div className="container mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:block">
            <h2 className="text-xl font-semibold text-charcoal-800">Freight Reporting Dashboard</h2>
          </div>

          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-medium text-charcoal-800">{user?.email}</p>
            ...
            >
              <HelpCircle className="w-5 h-5 text-charcoal-600" />
            </button>

            <button
              onClick={() => signOut()}
              className="flex items-center gap-2 px-4 py-2 bg-charcoal-800 hover:bg-charcoal-700 text-white rounded-lg transition-colors"
            >
