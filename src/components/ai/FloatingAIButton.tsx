...
const CONTEXT_SUGGESTIONS: Record<string, string[]> = {
  ...
  '/pulse': [
    ...
    'Summarize my logistics performance this week',
  ],
  '/dashboard': [
  ...
  '/shipments': [
    ...
    'Show my most expensive shipments',
    'Find shipments with accessorial charges',
  ],
  '/shipment-detail': [
    'Show other shipments on this route',
    'What accessorials were charged?',
    'Compare this shipment to similar ones',
  ],
  '/analytics': [
    'Which lanes have the highest cost per mile?',
    'Show carrier performance trends',
    'Identify cost saving opportunities',
  ],
  '/ai-studio': [
    'Create a carrier performance report',
