...
interface Alert {
  ...
  metric?: string;
  change?: number;
  methodology?: string; // Explains how this insight was calculated
...
async function detectAlerts(
  ...
  // Calculate previous period for methodology display
  ...
  try {
    ...
    // Return ALL alerts - UI will handle expansion
    return alerts;
  } catch (error) {
