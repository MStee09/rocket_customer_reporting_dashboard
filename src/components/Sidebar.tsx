...
import { LayoutDashboard, Truck, Users, FileText, X, UserCog, Settings, BookOpen, Sparkles, LucideIcon, Bookmark, ChevronDown, Pin, HelpCircle, Eye, Activity, BarChart3, Blocks, LayoutGrid } from 'lucide-react';
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const adminNavItems: NavItem[] = [
    ...
    { to: '/widget-library', icon: LayoutGrid, label: 'Widget Library' },
