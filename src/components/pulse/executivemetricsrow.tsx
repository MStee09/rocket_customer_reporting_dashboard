...
// Helper to format period for tooltip
...
export function ExecutiveMetricsRow({ customerId, startDate, endDate }: ExecutiveMetricsRowProps) {
  ...
  if (error || !metrics) {
    const emptyKpis = [
      { icon: Package, label: 'Total Shipments', iconBg: 'bg-blue-100', iconColor: 'text-blue-600', metricId: 'total_shipments' as const },
      { icon: DollarSign, label: 'Total Spend', iconBg: 'bg-emerald-100', iconColor: 'text-emerald-600', metricId: 'total_spend' as const },
      { icon: Clock, label: 'On-Time %', iconBg: 'bg-teal-100', iconColor: 'text-teal-600', metricId: 'on_time_percentage' as const },
      { icon: Truck, label: 'Active Carriers', iconBg: 'bg-cyan-100', iconColor: 'text-cyan-600', metricId: 'active_carriers' as const },
    ];
  ...
  const kpis = [
    {
      ...
      inverse: false,
      metricId: 'total_shipments' as const,
    ...
    },
    {
      ...
      inverse: false,
      statusThreshold: 90,
      metricId: 'on_time_percentage' as const,
      recordCount: metrics.totalShipments,
    },
    {
      ...
      inverse: false,
      showStable: true,
      metricId: 'active_carriers' as const,
    },
  ];
