/*
  # Fix Pulse Functions - Use created_date Column

  1. Changes
    - Changed all references from `created_at` to `created_date`
    - The shipment table uses `created_date`, not `created_at`

  2. Functions Updated
    - get_pulse_executive_metrics
    - get_pulse_spend_trend
    - get_pulse_top_carriers
    - get_pulse_performance_summary
*/
