/**
 * CustomerScopeSelector - Select who this widget is for
 * 
 * This is displayed at the TOP of the Visual Builder to set context
 * before any other configuration.
 * 
 * LOCATION: /src/admin/visual-builder/components/CustomerScopeSelector.tsx
 */
        ...
        <>
          ...
          <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg shadow-lg border border-slate-200 z-20 overflow-hidden">
            ...
            >
              ...
              {scope.mode === 'admin' && <Check className="w-4 h-4 text-purple-600" />}
            </button>
