...
// =============================================================================
// CUSTOMER SCOPE (NEW - Optional, Backwards Compatible)
// =============================================================================
...
/**
 * Determine which chart types are available based on current field selection
 */
export function getChartTypeAvailability(
  ...
  return [
    ...
    // Scatter needs both X and Y numeric
    {
      type: 'scatter',
    ...
    // Flow map needs origin AND destination
    {
      type: 'flow',
      available: false,
    ...
    // Histogram needs a numeric X field
    {
      type: 'histogram',
      available: hasXField,
    ...
    // Funnel needs category and value
    {
      type: 'funnel',
      available: hasXField && hasYField,
...
export interface VisualBuilderSchema {
  ...
  // NEW: Customer scope (optional for backwards compatibility)
