  ...
  const loadUserRole = async (userId: string) => {
    ...
    try {
      ...
      if (roleData) {
        ...
        // Clear impersonation state on role load to prevent stale sessionStorage
        // from blocking access. Impersonation should be explicitly re-enabled.
        if (userRole !== 'admin') {
        ...
        // Note: For admins, we preserve viewing/impersonation state from sessionStorage
        // This allows the state to persist during page refreshes within a session
