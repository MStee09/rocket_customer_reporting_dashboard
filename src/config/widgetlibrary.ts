...
export const widgetLibrary: Record<string, WidgetDefinition> = {
  ...
  flow_map: {
    ...
    tooltip: 'Interactive map showing origin → destination shipping lanes',
  ...
  top_lanes: {
    ...
    tooltip: 'COUNT(*) and AVG(cost) by origin → destination',
  ...
  on_time_pct: {
    ...
    icon: 'Clock',
    iconColor: 'bg-purple-500',
    tooltip: '(On-time deliveries / Total deliveries) × 100',
