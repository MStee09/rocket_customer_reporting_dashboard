/*
  # Add Auth Verification to Pulse Functions

  1. Changes
    - Updated all pulse functions to verify customer access before returning data
    - Uses verify_customer_access function created in previous migration
    - Adds authentication requirement check
    - Maintains backward compatibility with existing function signatures

  2. Security
    - All pulse functions now require authentication
    - Users can only access data for customers they have access to
