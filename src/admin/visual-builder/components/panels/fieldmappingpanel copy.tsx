/**
 * FieldMappingPanel - Configure data field mappings
 * 
 * Maps database fields to chart axes/dimensions.
 */
...
// =============================================================================
// AVAILABLE FIELDS (from shipment_report_view)
// =============================================================================
...
export function FieldMappingPanel() {
  ...
  // Determine what fields are needed based on viz type
