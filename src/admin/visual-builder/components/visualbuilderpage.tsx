 ...
 * 
 * LOCATION: /src/admin/visual-builder/components/VisualBuilderPage.tsx
 * 
 ...
 * - Customer selector for preview context
...
// =============================================================================
// PREVIEW CUSTOMER CONTEXT
// =============================================================================

interface PreviewCustomerContextValue {
  previewCustomerId: number | null; // null = all customers (admin view)
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 p-6">
          ...
          <div className="flex-1">
            ...
            {draft.title && (
              <p className="text-sm text-slate-700 mt-2">
                <strong>Widget:</strong> {draft.title}
              </p>
            )}
          </div>
        </div>
        <div className="flex gap-3 mt-6">
          ...
          <button
            onClick={onRestore}
            className="flex-1 px-4 py-2 text-white bg-orange-500 hover:bg-orange-600 rounded-lg text-sm font-medium transition-colors"
          >
            Restore Draft
          </button>
        </div>
