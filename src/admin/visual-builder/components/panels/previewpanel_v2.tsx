/**
 * Preview Panel - MCP-Enabled Version (Direct RPC)
 *
 * LOCATION: /src/admin/visual-builder/components/panels/PreviewPanel.tsx
 *
 * This version calls MCP SQL functions directly via Supabase RPC,
 * avoiding the need to go through the generate-report Edge Function.
 */
...
export function PreviewPanel() {
  ...
  const fetchPreviewDataWithMCP = async () => {
    ...
    try {
      ...
      // Call MCP query_with_join directly via RPC
...
function processDataForVisualization(rawData: any[], config: any, productFilters: string[]): any[] {
  ...
  // For MCP product queries - group by description matching products
