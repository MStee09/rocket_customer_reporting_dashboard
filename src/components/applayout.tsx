...
export function AppLayout() {
  ...
  // Confirmation dialog state for impersonation exit
  ...
  return (
    <>
      {/* RED BORDER FOR IMPERSONATION - impossible to miss */}
      <div
        className={`flex h-screen bg-slate-50 ${
          isImpersonating ? 'ring-4 ring-inset ring-red-500' : ''
        }`}
      >
        {/* IMPERSONATION BANNER - RED with warning */}
        ...
        {/* VIEW AS CUSTOMER BANNER - Blue (less dangerous) */}
