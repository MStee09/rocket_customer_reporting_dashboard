...
export function SettingsPage() {
  ...
  // Load AI settings when tab is selected
  useEffect(() => {
            ...
            {isLoadingPrompt ? (
              ...
              <>
                <textarea
                  ...
                  rows={20}
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg font-mono text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-y"
