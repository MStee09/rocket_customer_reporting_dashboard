...
// =============================================================================
// MCP-BASED TOOLS (Using your database functions)
// =============================================================================
...
// =============================================================================
// SYSTEM PROMPT - MCP-Based Discovery
// =============================================================================
...
// =============================================================================
// TOOL EXECUTOR - Calls MCP Database Functions
// =============================================================================
  ...
  switch (toolName) {
    ...
    case 'discover_fields': {
      ...
      return {
        ...
        fields,
        summary: {
          groupable: fields.filter((f: any) => f.is_groupable).map((f: any) => f.field_name),
          aggregatable: fields.filter((f: any) => f.is_aggregatable).map((f: any) => f.field_name),
          searchable: fields.filter((f: any) => f.is_searchable).map((f: any) => f.field_name)
        }
      };
    }
...
function generateVisualization(
  ...
  if ((toolName === 'aggregate' || toolName === 'query_with_join' || toolName === 'query_table') && 
    ...
    // Find the value field (could be 'value', 'count', or the metric name)
