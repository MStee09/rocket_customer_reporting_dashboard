...
// Bento grid constraints - optimized for 4-column Apple-style layout
...
// Widget-specific overrides for bento visual hierarchy
const widgetSpecificConstraints: Record<string, Partial<WidgetConstraints>> = {
  flow_map: { minSize: 2, maxSize: 4, optimalSize: 4, minHeight: 450 },  // Hero: full width
...
// Bento grid column spans for 4-column layout
